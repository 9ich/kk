...
extern vmCvar_t cg_crosshair;
extern vmCvar_t cg_crosshairNames;
...
extern vmCvar_t	cg_testmodelscale;
#ifdef MISSIONPACK
...
extern vmCvar_t cg_thrustLight;
...
void		drawtourneyscoreboard(void);
