...
int		numonteam(int team);
int		numaliveonteam(int team);
void		addteamscore(vec3_t origin, int team, int score);

void		droppedflag_think(gentity_t *ent);
void		fragbonuses(gentity_t *targ, gentity_t *inflictor, gentity_t *attacker);
void		chkhurtcarrier(gentity_t *targ, gentity_t *attacker);
void		teamgameinit(void);
